...
var artifactMessageTypes map[string]messageFactory = map[string]messageFactory{
	...
	"google.cloud.apigeeregistry.v1.apihub.Attributes":           func() proto.Message { return new(apihub.Attributes) },
	"google.cloud.apigeeregistry.v1.apihub.AttributesDefinition": func() proto.Message { return new(apihub.AttributesDefinition) },
