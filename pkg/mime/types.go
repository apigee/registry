...
var artifactMessageTypes map[string]messageFactory = map[string]messageFactory{
	...
	"google.cloud.apigeeregistry.v1.apihub.AttributeSet":           func() proto.Message { return new(apihub.AttributeSet) },
	"google.cloud.apigeeregistry.v1.apihub.AttributeSetDefinition": func() proto.Message { return new(apihub.AttributeSetDefinition) },
