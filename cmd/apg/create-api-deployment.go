...
func init() {
	...
	CreateApiDeploymentCmd.Flags().StringVar(&CreateApiDeploymentInput.Parent, "parent", "", "Required. Required. The parent, which owns this collection...")
	...
	CreateApiDeploymentCmd.Flags().StringVar(&CreateApiDeploymentInput.ApiDeploymentId, "api_deployment_id", "", "Required. Required. The ID to use for the deployment, which...")
