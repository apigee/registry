...
func init() {
	...
	RollbackApiDeploymentCmd.Flags().StringVar(&RollbackApiDeploymentInput.Name, "name", "", "Required. Required. The deployment being rolled back.")

	RollbackApiDeploymentCmd.Flags().StringVar(&RollbackApiDeploymentInput.RevisionId, "revision_id", "", "Required. Required. The revision ID to roll back to.  It...")
