...
func init() {
	...
	TagApiDeploymentRevisionCmd.Flags().StringVar(&TagApiDeploymentRevisionInput.Name, "name", "", "Required. Required. The name of the deployment to be...")

	TagApiDeploymentRevisionCmd.Flags().StringVar(&TagApiDeploymentRevisionInput.Tag, "tag", "", "Required. Required. The tag to apply.  The tag should be at...")
