...
func init() {
	...
	RollbackApiSpecCmd.Flags().StringVar(&RollbackApiSpecInput.Name, "name", "", "Required. Required. The spec being rolled back.")

	RollbackApiSpecCmd.Flags().StringVar(&RollbackApiSpecInput.RevisionId, "revision_id", "", "Required. Required. The revision ID to roll back to.  It...")
