...
func init() {
	...
	TagApiSpecRevisionCmd.Flags().StringVar(&TagApiSpecRevisionInput.Name, "name", "", "Required. The name of the spec to be tagged, including the...")

	TagApiSpecRevisionCmd.Flags().StringVar(&TagApiSpecRevisionInput.Tag, "tag", "", "Required. The tag to apply.  The tag should be at most 40...")
