...
func (*SampleLinterRunner) Run(req *artifacts.LinterRequest) (*artifacts.LinterResponse, error) {
	...
	for _, rule := range req.RuleIds {
		lintFile.Problems = append(lintFile.Problems, &artifacts.LintProblem{
			RuleId:  rule,
