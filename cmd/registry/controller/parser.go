...
func ValidateManifest(parent string, manifest *artifacts.Manifest) []error {
...
func validateGeneratedResourceEntry(parent string, generatedResource *artifacts.GeneratedResource) []error {
