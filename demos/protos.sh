...
registry compute details projects/protos/locations/global/apis/-
...
registry list projects/protos/locations/global/apis

# We can count them by piping this through `wc -l`.
registry list projects/protos/locations/global/apis | wc -l

# Many of these APIs have multiple versions. We can list all of the API versions
# by using a "-" wildcard for the API id:
registry list projects/protos/locations/global/apis/-/versions
...
registry list projects/protos/locations/global/apis/-/versions/-/specs

# To see more about an individual spec, use the `registry get` command:
registry get projects/protos/locations/global/apis/google-cloud-translate/versions/v3/specs/protos.zip

# You can also get this with the automatically-generated `apg` command line tool:
apg registry get-api-spec --name projects/protos/locations/global/apis/google-cloud-translate/versions/v3/specs/protos.zip

# Add the `--json` flag to get this as JSON:
apg registry get-api-spec --name projects/protos/locations/global/apis/google-cloud-translate/versions/v3/specs/protos.zip --json
...
registry get projects/protos/locations/global/apis/google-cloud-translate/versions/v3/specs/protos.zip --contents > protos.zip
...
registry compute complexity projects/protos/locations/global/apis/-/versions/-/specs/-

# Complexity results are stored in artifacts associated with the specs.
registry list projects/protos/locations/global/apis/-/versions/-/specs/-/artifacts/complexity

# We can use the `registry get` subcommand to read individual complexity records.
registry get projects/protos/locations/global/apis/google-cloud-translate/versions/v3/specs/protos.zip/artifacts/complexity
...
registry export sheet projects/protos/locations/global/apis/-/versions/-/specs/-/artifacts/complexity \
	--as projects/protos/locations/global/artifacts/complexity-sheet

# We can also compute the vocabulary of proto APIs.
registry compute vocabulary projects/protos/locations/global/apis/-/versions/-/specs/-

# Vocabularies are also stored as artifacts associated with API specs.
registry get projects/protos/locations/global/apis/google-cloud-translate/versions/v3/specs/protos.zip/artifacts/vocabulary
...
registry vocabulary intersection projects/protos/locations/global/apis/-/versions/-/specs/-/artifacts/vocabulary --filter "api_id.contains('speech')"

# We can also save this to a property.
registry vocabulary intersection projects/protos/locations/global/apis/-/versions/-/specs/-/artifacts/vocabulary --filter "api_id.contains('speech')" --output projects/protos/locations/global/artifacts/speech-common

# We can then read it directly or export it to a Google Sheet.
registry get projects/protos/locations/global/artifacts/speech-common
registry export sheet projects/protos/locations/global/artifacts/speech-common

# To see a larger vocabulary, let's now compute the union of all the vocabularies in our project.
registry vocabulary union projects/protos/locations/global/apis/-/versions/-/specs/-/artifacts/vocabulary --output projects/protos/locations/global/artifacts/vocabulary

# We can also export this with `registry get` but it's easier to view this as a sheet:
registry export sheet projects/protos/locations/global/artifacts/vocabulary
...
registry compute lint projects/protos/locations/global/apis/-/versions/-/specs/-
registry compute lintstats projects/protos/locations/global/apis/-/versions/-/specs/- --linter aip
