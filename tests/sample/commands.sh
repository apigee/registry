...
apg registry create-api --parent projects/sample --api_id petstore

echo add a version to the registry
apg registry create-version --parent projects/sample/apis/petstore --version_id 1.0.0
...
apg registry update-spec \
	--spec.name projects/sample/apis/petstore/versions/1.0.0/specs/openapi.yaml \
...
apg registry rollback-spec --name projects/sample/apis/petstore/versions/1.0.0/specs/openapi.yaml --revision_id og
...
apg registry delete-spec  --name projects/sample/apis/petstore/versions/1.0.0/specs/openapi.yaml
